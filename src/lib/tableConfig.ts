...
export const tableConfigs: Record<string, TableConfig> = {
  ...
  ar_shop_items: {
    ...
    columns: [
      ...
      { key: "shop_id", label: "Shop ID", type: "number", required: true, editable: true, showInTable: true, showInForm: true, placeholder: "Shop number" },
  ...
  ar_shops: {
    ...
    columns: [
      ...
      { key: "node_id", label: "Node ID", type: "number", editable: true, showInTable: true, showInForm: false },
      { key: "pos_x", label: "Position X", type: "number", editable: true, showInTable: false, showInForm: false },
      { key: "pos_y", label: "Position Y", type: "number", editable: true, showInTable: false, showInForm: false },
      { key: "pos_z", label: "Position Z", type: "number", editable: true, showInTable: false, showInForm: false },
      { key: "image_url", label: "Image Link", type: "text", editable: true, showInTable: false, showInForm: false },
      { key: "image_blob", label: "Image Data", type: "text", editable: true, showInTable: false, showInForm: false },
      { key: "file_name", label: "File Name", type: "text", editable: true, showInTable: false, showInForm: false },
      { key: "mime_type", label: "Mime Type", type: "text", editable: true, showInTable: false, showInForm: false },
      { key: "shop_url", label: "Website", type: "text", editable: true, showInTable: false, showInForm: false },
      { key: "created_at", label: "Added On", type: "datetime", editable: false, showInTable: true, showInForm: false },
    ],
  },
